...
GEMMA_FWD_ONLY = os.getenv("FLASH_ATTENTION_GEMMA_FWD_ONLY", "FALSE") == "TRUE"
...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    if GEMMA_FWD_ONLY:
        nvcc_flags.append("-DFLASHATTENTION_GEMMA_FWD_ONLY")
        compiler_c17_flag.append("-DFLASHATTENTION_GEMMA_FWD_ONLY")
