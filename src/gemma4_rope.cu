...
cudaError_t gemma4_sliding_rope_bf16(floatX *q,
  ...
  return gemma4_rope_bf16(
      ...
      GEMMA4_SLIDING_HEAD_DIM / 2, sin, GEMMA4_SLIDING_HEAD_DIM / 2, seq_len,
...
cudaError_t gemma4_global_rope_bf16(floatX *q,
  ...
  return gemma4_rope_bf16(
      ...
      kGemma4GlobalRotaryDim / 2, sin, kGemma4GlobalRotaryDim / 2,
      seq_len, batch_size, cos_batch_size, GEMMA4_NUM_QUERY_HEADS,
      GEMMA4_GLOBAL_KV_HEADS, GEMMA4_GLOBAL_HEAD_DIM, kGemma4GlobalRotaryDim,
      stream);
}
