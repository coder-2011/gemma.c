...
def env_snapshot():
    ...
    env = benchmark_environment("project_prepare_compare")
    env.update({
...
def main():
    ...
    contract = benchmark_contract(
        name="project_prepare_compare",
        measurement="typical latency for project->prepare stream work",
        timing="cuda_events_current_pytorch_stream",
        cache="warm_repeated_buffers",
        cache_mode="warm",
        launch_overhead="host_wall_time_excluded_by_cuda_events",
