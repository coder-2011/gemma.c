...
// Runs the experimental Tier-2 decode FFN MLP and writes one natural-order row.
...
// Runs the experimental Tier-2 decode FFN plus post-FFN RMSNorm/residual add.
