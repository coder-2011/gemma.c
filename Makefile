...
RDC_LTO_NVCCFLAGS ?= $(RDC_NVCCFLAGS) -dlto
...
.PHONY: all cuda-kernels prompt benchmarks decode-bench embedding-gather-bench sampling-bench rmsnorm-bench rmsnorm-hidden-fused-bench ffn-libtorch-bench flash-attn-bench kv-cache-bench tokenizer-bench flash-attn-lib test-cuda-utils test-tokenizer test-embedding-gather test-sampling test-rmsnorm test-ffn-decode test-prefill-gemm test-kv-cache test-flash-attention test-flash-attention-cpp test-runtime-state test-decode-megakernel test-prefill-megakernel test-checkpoint-loader clean

all: cuda-kernels

cuda-kernels: $(BUILD_DIR)/gemma4_matmul_kernels.o $(BUILD_DIR)/gemma4_sampling.o $(BUILD_DIR)/gemma4_rmsnorm.o $(BUILD_DIR)/gemma4_rope.o $(BUILD_DIR)/gemma4_flash_attention_decode.o $(BUILD_DIR)/gemma4_flash_attention_prefill.o $(BUILD_DIR)/gemma4_ffn.o $(BUILD_DIR)/gemma4_kv_cache.o $(BUILD_DIR)/gemma4_runtime.o $(BUILD_DIR)/gemma4_decode_megakernel.o $(BUILD_DIR)/gemma4_prefill_megakernel.o $(BUILD_DIR)/gemma4_checkpoint.o
...
test-kv-cache: $(BUILD_DIR)/tests/test_kv_cache
	./$<
test-flash-attention: test-flash-attention-cpp
...
$(BUILD_DIR)/gemma4_matmul_kernels.o: src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) -c src/gemma4_matmul_kernels.cu -o $@
...
$(BUILD_DIR)/gemma4_flash_attention_decode.o: src/gemma4_flash_attention_decode.cu src/gemma4_megakernel.cuh src/gemma4_ffn.cuh src/gemma4_kv_cache.cuh src/gemma4_rmsnorm.cuh src/gemma4_rope.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) -c src/gemma4_flash_attention_decode.cu -o $@

$(BUILD_DIR)/gemma4_flash_attention_prefill.o: src/gemma4_flash_attention_prefill.cu src/gemma4_flash_attention.cuh src/gemma4_rmsnorm.cuh src/gemma4_rope.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) -c src/gemma4_flash_attention_prefill.cu -o $@

$(BUILD_DIR)/gemma4_ffn.o: src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_matmul_kernels.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) -c src/gemma4_ffn.cu -o $@
...
$(BUILD_DIR)/gemma4_runtime.o: src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_kv_cache.cuh src/gemma4_rope.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) -I$(FLASH_ATTN_CUTLASS_INCLUDE) -c src/gemma4_runtime.cu -o $@

$(BUILD_DIR)/gemma4_decode_megakernel.o: src/gemma4_decode_megakernel.cu src/gemma4_megakernel.cuh src/gemma4_flash_attention.cuh src/gemma4_matmul_kernels.cuh src/gemma4_kv_cache.cuh src/gemma4_ffn.cuh src/gemma4_sampling.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) -c src/gemma4_decode_megakernel.cu -o $@

$(BUILD_DIR)/gemma4_prefill_megakernel.o: src/gemma4_prefill_megakernel.cu src/gemma4_megakernel.cuh src/gemma4_checkpoint.cuh src/gemma4_flash_attention.cuh src/gemma4_kv_cache.cuh src/gemma4_ffn.cuh src/gemma4_matmul_kernels.cuh src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
...
$(BUILD_DIR)/libgemma4_flash_attention.so: src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_flash_attention.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_decode_megakernel.cu src/gemma4_megakernel.cuh src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_sampling.cu src/gemma4_sampling.cuh src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_rope.cu src/gemma4_rope.cuh src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) -Xcompiler -fPIC -shared $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_matmul_kernels.cu src/gemma4_decode_megakernel.cu src/gemma4_runtime.cu src/gemma4_sampling.cu src/gemma4_ffn.cu src/gemma4_rmsnorm.cu src/gemma4_kv_cache.cu src/gemma4_rope.cu src/gemma4_embedding_gather.cu -o $@

$(BUILD_DIR)/gemma4_prompt: src/gemma4_prompt.cu src/benches/gemma4_bench_utils.cuh src/gemma4_tokenizer.cuh src/gemma4_cuda_utils.cuh src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4_runtime.cuh src/gemma4_megakernel.cuh $(BUILD_DIR)/gemma4_tokenizer.o $(BUILD_DIR)/gemma4_checkpoint.o $(BUILD_DIR)/gemma4_runtime.o $(BUILD_DIR)/gemma4_prefill_megakernel.o $(BUILD_DIR)/gemma4_decode_megakernel.o $(BUILD_DIR)/gemma4_sampling.o $(BUILD_DIR)/gemma4_matmul_kernels.o $(BUILD_DIR)/gemma4_flash_attention_decode.o $(BUILD_DIR)/gemma4_flash_attention_prefill.o $(BUILD_DIR)/gemma4_rope.o $(BUILD_DIR)/gemma4_kv_cache.o $(BUILD_DIR)/gemma4_ffn.o $(BUILD_DIR)/gemma4_rmsnorm.o | $(BUILD_DIR)
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) src/gemma4_prompt.cu src/gemma4_embedding_gather.cu $(BUILD_DIR)/gemma4_tokenizer.o $(BUILD_DIR)/gemma4_checkpoint.o $(BUILD_DIR)/gemma4_runtime.o $(BUILD_DIR)/gemma4_prefill_megakernel.o $(BUILD_DIR)/gemma4_decode_megakernel.o $(BUILD_DIR)/gemma4_sampling.o $(BUILD_DIR)/gemma4_matmul_kernels.o $(BUILD_DIR)/gemma4_flash_attention_decode.o $(BUILD_DIR)/gemma4_flash_attention_prefill.o $(BUILD_DIR)/gemma4_rope.o $(BUILD_DIR)/gemma4_kv_cache.o $(BUILD_DIR)/gemma4_ffn.o $(BUILD_DIR)/gemma4_rmsnorm.o $(CUDA_LDFLAGS) -lcublas -o $@
...
$(BUILD_DIR)/benches/gemma4_decode_bench: src/benches/gemma4_decode_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) -I$(CUDNN_INCLUDE) src/benches/gemma4_decode_bench.cu src/gemma4_matmul_kernels.cu src/gemma4_rmsnorm.cu $(CUDA_LDFLAGS) -lcublas $(CUDNN_LDFLAGS) -o $@
...
$(BUILD_DIR)/benches/gemma4_ffn_libtorch_bench: src/benches/gemma4_ffn_libtorch_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(TORCH_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(TORCH_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) src/benches/gemma4_ffn_libtorch_bench.cu src/gemma4_ffn.cu src/gemma4_matmul_kernels.cu src/gemma4_rmsnorm.cu $(TORCH_LDFLAGS) $(TORCH_LIBS) -o $@

$(BUILD_DIR)/benches/gemma4_flash_attention_bench: src/benches/gemma4_flash_attention_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_flash_attention.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_decode_megakernel.cu src/gemma4_megakernel.cuh src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_sampling.cu src/gemma4_sampling.cuh src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_rope.cu src/gemma4_rope.cuh src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(TORCH_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(TORCH_CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) src/benches/gemma4_flash_attention_bench.cu src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_matmul_kernels.cu src/gemma4_decode_megakernel.cu src/gemma4_runtime.cu src/gemma4_kv_cache.cu src/gemma4_sampling.cu src/gemma4_ffn.cu src/gemma4_rope.cu src/gemma4_embedding_gather.cu src/gemma4_rmsnorm.cu $(TORCH_LDFLAGS) $(TORCH_LIBS) -o $@

$(BUILD_DIR)/benches/gemma4_kv_cache_bench: src/benches/gemma4_kv_cache_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) -I$(FLASH_ATTN_CUTLASS_INCLUDE) src/benches/gemma4_kv_cache_bench.cu src/gemma4_kv_cache.cu -o $@
...
$(BUILD_DIR)/tests/test_ffn_decode: tests/test_ffn_decode.cu src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/tests
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) tests/test_ffn_decode.cu src/gemma4_ffn.cu src/gemma4_matmul_kernels.cu src/gemma4_rmsnorm.cu -o $@
...
$(BUILD_DIR)/tests/test_flash_attention: tests/test_flash_attention.cu src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_flash_attention.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_decode_megakernel.cu src/gemma4_megakernel.cuh src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_sampling.cu src/gemma4_sampling.cuh src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_rope.cu src/gemma4_rope.cuh src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/tests
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) tests/test_flash_attention.cu src/gemma4_kv_cache.cu src/gemma4_flash_attention_decode.cu src/gemma4_flash_attention_prefill.cu src/gemma4_matmul_kernels.cu src/gemma4_decode_megakernel.cu src/gemma4_runtime.cu src/gemma4_sampling.cu src/gemma4_ffn.cu src/gemma4_rope.cu src/gemma4_embedding_gather.cu src/gemma4_rmsnorm.cu $(CUDA_LDFLAGS) -lcublas -o $@

$(BUILD_DIR)/tests/test_runtime_state: tests/test_runtime_state.cu src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_rope.cuh src/gemma4.h | $(BUILD_DIR)/tests
...
$(BUILD_DIR)/tests/test_decode_megakernel: tests/test_decode_megakernel.cu src/gemma4_decode_megakernel.cu src/gemma4_flash_attention_decode.cu src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_runtime.cu src/gemma4_runtime.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_sampling.cu src/gemma4_ffn.cu src/gemma4_rmsnorm.cu src/gemma4_megakernel.cuh src/gemma4_flash_attention.cuh src/gemma4_rmsnorm.cuh src/gemma4_rope.cu src/gemma4_rope.cuh src/gemma4_ffn.cuh src/gemma4_sampling.cuh src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/tests
	$(NVCC) $(NVCCFLAGS) $(RDC_NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) tests/test_decode_megakernel.cu src/gemma4_decode_megakernel.cu src/gemma4_flash_attention_decode.cu src/gemma4_matmul_kernels.cu src/gemma4_runtime.cu src/gemma4_kv_cache.cu src/gemma4_sampling.cu src/gemma4_ffn.cu src/gemma4_rope.cu src/gemma4_rmsnorm.cu src/gemma4_embedding_gather.cu -o $@

$(BUILD_DIR)/tests/test_prefill_megakernel: tests/test_prefill_megakernel.cu src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh $(BUILD_DIR)/gemma4_prefill_megakernel.o $(BUILD_DIR)/gemma4_matmul_kernels.o $(BUILD_DIR)/gemma4_flash_attention_decode.o $(BUILD_DIR)/gemma4_flash_attention_prefill.o $(BUILD_DIR)/gemma4_decode_megakernel.o $(BUILD_DIR)/gemma4_runtime.o $(BUILD_DIR)/gemma4_sampling.o $(BUILD_DIR)/gemma4_rope.o $(BUILD_DIR)/gemma4_kv_cache.o $(BUILD_DIR)/gemma4_ffn.o $(BUILD_DIR)/gemma4_rmsnorm.o | $(BUILD_DIR)/tests
	$(NVCC) $(NVCCFLAGS) $(RDC_LTO_NVCCFLAGS) $(CPPFLAGS) -I$(FLASH_ATTN_CUTLASS_INCLUDE) tests/test_prefill_megakernel.cu src/gemma4_embedding_gather.cu $(BUILD_DIR)/gemma4_prefill_megakernel.o $(BUILD_DIR)/gemma4_matmul_kernels.o $(BUILD_DIR)/gemma4_flash_attention_decode.o $(BUILD_DIR)/gemma4_flash_attention_prefill.o $(BUILD_DIR)/gemma4_decode_megakernel.o $(BUILD_DIR)/gemma4_runtime.o $(BUILD_DIR)/gemma4_sampling.o $(BUILD_DIR)/gemma4_rope.o $(BUILD_DIR)/gemma4_kv_cache.o $(BUILD_DIR)/gemma4_ffn.o $(BUILD_DIR)/gemma4_rmsnorm.o $(CUDA_LDFLAGS) -lcublas -o $@
