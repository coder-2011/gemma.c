...
$(BUILD_DIR)/gemma4_decode_megakernel.o: src/gemma4_decode_megakernel.cu src/gemma4_decode_megakernel.cuh src/gemma4_decode_megakernel_phases.cuh src/gemma4_flash_attention.cuh src/gemma4_kv_cache.cuh src/gemma4_ffn.cuh src/gemma4_ffn_decode_device.cuh src/gemma4_rmsnorm_device.cuh src/gemma4_sampling.cuh src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)
...
$(BUILD_DIR)/benches/gemma4_sampling_bench: src/benches/gemma4_sampling_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_sampling.cu src/gemma4_sampling.cuh src/gemma4_matmul_kernels.cu src/gemma4_matmul_kernels.cuh src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) src/benches/gemma4_sampling_bench.cu src/gemma4_sampling.cu src/gemma4_matmul_kernels.cu -o $@
...
$(BUILD_DIR)/benches/gemma4_rmsnorm_bench: src/benches/gemma4_rmsnorm_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) -I$(CUDNN_INCLUDE) -I$(CUDNN_FRONTEND_INCLUDE) src/benches/gemma4_rmsnorm_bench.cu src/gemma4_rmsnorm.cu $(CUDA_LDFLAGS) $(CUDNN_LDFLAGS) -lnvrtc -lcuda -o $@
...
$(BUILD_DIR)/benches/gemma4_rmsnorm_hidden_fused_bench: src/benches/gemma4_rmsnorm_hidden_fused_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) src/benches/gemma4_rmsnorm_hidden_fused_bench.cu src/gemma4_rmsnorm.cu -o $@

$(BUILD_DIR)/benches/gemma4_ffn_cudnn_bench: src/benches/gemma4_ffn_cudnn_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_ffn.cu src/gemma4_ffn.cuh src/gemma4_ffn_decode_device.cuh src/gemma4_rmsnorm.cu src/gemma4_rmsnorm.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(FFN_CUTLASS_NVCCFLAGS) $(CPPFLAGS) $(FFN_CUTLASS_CPPFLAGS) -I$(CUDNN_INCLUDE) -I$(CUDNN_FRONTEND_INCLUDE) src/benches/gemma4_ffn_cudnn_bench.cu src/gemma4_ffn.cu src/gemma4_rmsnorm.cu $(CUDA_LDFLAGS) $(CUDNN_LDFLAGS) -lnvrtc -lcuda -o $@
...
$(BUILD_DIR)/benches/gemma4_flash_attention_bench: src/benches/gemma4_flash_attention_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_flash_attention.cu src/gemma4_flash_attention.cuh src/gemma4_rope.cuh src/gemma4_kv_cache.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) src/benches/gemma4_flash_attention_bench.cu src/gemma4_flash_attention.cu -o $@

$(BUILD_DIR)/benches/gemma4_kv_cache_bench: src/benches/gemma4_kv_cache_bench.cu src/benches/gemma4_bench_utils.cuh src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_flash_attention.cu src/gemma4_flash_attention.cuh src/gemma4_rope.cuh src/gemma4_cuda_utils.cuh src/gemma4.cpp src/gemma4.h | $(BUILD_DIR)/benches
	$(NVCC) $(NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) src/benches/gemma4_kv_cache_bench.cu src/gemma4_kv_cache.cu src/gemma4_flash_attention.cu src/gemma4.cpp -o $@
...
$(BUILD_DIR)/tests/test_sampling: tests/test_sampling.cu src/gemma4_sampling.cu src/gemma4_sampling.cuh src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/tests
...
$(BUILD_DIR)/tests/test_flash_attention: tests/test_flash_attention.cu src/gemma4_kv_cache.cu src/gemma4_kv_cache.cuh src/gemma4_flash_attention.cu src/gemma4_flash_attention.cuh src/gemma4_rope.cuh src/gemma4_cuda_utils.cuh src/gemma4.cpp src/gemma4.h | $(BUILD_DIR)/tests
	$(NVCC) $(NVCCFLAGS) $(FLASH_ATTN_NVCCFLAGS) $(CPPFLAGS) $(FLASH_ATTN_CUTLASS_CPPFLAGS) tests/test_flash_attention.cu src/gemma4_kv_cache.cu src/gemma4_flash_attention.cu src/gemma4.cpp $(CUDA_LDFLAGS) -lcublas -o $@
...
$(BUILD_DIR)/tests/test_decode_megakernel: tests/test_decode_megakernel.cu src/gemma4_decode_megakernel.cu src/gemma4_flash_attention.cu src/gemma4_decode_megakernel.cuh src/gemma4_decode_megakernel_phases.cuh src/gemma4_flash_attention.cuh src/gemma4_rope.cuh src/gemma4_kv_cache.cuh src/gemma4_ffn.cuh src/gemma4_ffn_decode_device.cuh src/gemma4_rmsnorm_device.cuh src/gemma4_sampling.cuh src/gemma4_embedding_gather.cuh src/gemma4_cuda_utils.cuh src/gemma4.h | $(BUILD_DIR)/tests
