...
$(BUILD_DIR)/experiments/gemma4_embedding_gather_bench: src/experiments/gemma4_embedding_gather_bench.cu src/gemma4_embedding_gather.cu src/gemma4_embedding_gather.cuh src/gemma4.h $(BUILD_DIR)/gemma4.o | $(BUILD_DIR)/experiments
	$(NVCC) $(NVCCFLAGS) $(CPPFLAGS) src/experiments/gemma4_embedding_gather_bench.cu src/gemma4_embedding_gather.cu $(BUILD_DIR)/gemma4.o -o $@
